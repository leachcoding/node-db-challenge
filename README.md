...
SQL is a language to query through the relational databases.

- [ ] Why do tables need a `primary key`?

So you can join multiple tables.
...
Another table so you can mediate between the many to many relationships.
